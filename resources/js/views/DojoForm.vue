  ...
  <div>
    <div v-if="!signed_in">
      <h3 class="text-center">
        Sorry, you must be logged in to create a dojo.
      </h3>
    </div>
    <div v-else>
      ...
      <div class="card mb-4 p-3">
        <h5
          ...
          class="premium-required text-center"
          v-text="premiumWarningMessage"
        ></h5>
        <form
          name="dojo-form"
          class="row"
        ...
        >
          ...
          <div class="col" :class="{ 'col-lg-9': is_editing }">
            ...
            <div class="m-1 p-0 form-group row">
              <label class="col-sm-3 col-form-label"
                >Website:
                <span v-if="showPremiumWarning" class="premium-required"
                  >*</span
                ></label
              >
              <div class="col-sm-9">
            ...
            <div class="m-1 p-0 form-group row">
              <label class="col-sm-3 col-form-label">
                ...
                <small
                  v-if="showPremiumWarning"
                  class="premium-required d-block"
                  >The map will not be shown for standard memberships, but you
                  should still confirm your location in the map</small
                ></label
              >
              <div class="col-sm-9">
                <span
